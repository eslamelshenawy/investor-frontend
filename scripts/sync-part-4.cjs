...
const CATEGORIES = [
  { id: 'prices_and_indices', name: 'الأسعار والمؤشرات' },
  { id: 'laboratories', name: 'المختبرات' },
  { id: 'social_insurance', name: 'الضمان الاجتماعي' },
  { id: 'labor_market', name: 'سوق العمل' },
  { id: 'agriculture_and_fishing', name: 'الزراعة والأسماك' },
  { id: 'government-procurement', name: 'المشتريات الحكومية' },
  { id: 'information-technology', name: 'تقنية المعلومات' },
  { id: 'human-rights', name: 'حقوق الانسان' },
  { id: 'elderly', name: 'كبار السن' },
  { id: 'monitoring_agencies', name: 'الجهات الرقابية' },
];
...
async function main() {
  ...
  console.log('🚀 PART 4/5 - Categories 31-40');
  console.log('═'.repeat(50));
  ...
  await browser.close();
  console.log('═'.repeat(50));
  console.log(`✅ PART 4 COMPLETE - ${total} datasets, ${resourcesUpdated} resources`);
  console.log('═'.repeat(50));
  await pool.end();
}
